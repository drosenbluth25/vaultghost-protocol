...
VaultGhost Protocol is the canonical specification for a forensic, recursive method of tracing prompt influence, latent drift, and linguistic pattern replication across LLM systems. This repository contains the formal protocol specification and evidence artifacts.
